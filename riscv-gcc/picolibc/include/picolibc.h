...
#undef HAVE_BUILTIN_FFSLL

/* Compiler has __builtin_mul_overflow */
#undef HAVE_BUILTIN_MUL
...
#define _PICOLIBC_MINOR__ 5

/* The Picolibc version in string format. */
#define _PICOLIBC_VERSION "1.5.1"
