...
DEVICE_HEADERS="iom328*.h iom168*.h iom2560*.h iotn85*.h iotn84*.h iotn88*.h iom32u4.h"
...
DEVICE_LIBS="*mega328p* *mega168p* *mega168pa* *mega168pb* *mega2560* *tiny85* *tiny84* *tiny88* *mega32u4*"
